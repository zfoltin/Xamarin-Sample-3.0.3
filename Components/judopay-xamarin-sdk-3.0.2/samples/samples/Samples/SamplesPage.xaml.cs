...
namespace SampleApp
{
	public partial class SamplesPage : KeyboardAwarePage
	{
		...
		{
			_applePayService.Payment(BuildJudoForApplePay(), BuildWalletModel(), ApplePaySuccess, ApplePayFailure);
		}

		void PerformApplePayPreAuth(object sender, EventArgs e)
		{
			_applePayService.PreAuth(BuildJudoForApplePay(), BuildWalletModel(), ApplePaySuccess, ApplePayFailure);
		}
